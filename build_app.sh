...
echo "  Pruning idlelib..."
rm -rf "${LIB}/idlelib"
echo "  Pruning ensurepip..."
rm -rf "${LIB}/ensurepip"
echo "  Pruning unittest..."
rm -rf "${LIB}/unittest"
echo "  Pruning pydoc_data..."
rm -rf "${LIB}/pydoc_data"
echo "  Pruning _pyrepl..."
rm -rf "${LIB}/_pyrepl"
echo "  Pruning other unnecessary modules..."
rm -rf "${LIB}/turtle.py" "${LIB}/turtledemo"
rm -rf "${LIB}/doctest.py"
rm -rf "${LIB}/lib2to3"
rm -rf "${LIB}/distutils"
rm -rf "${LIB}/multiprocessing"
rm -rf "${LIB}/xmlrpc"
rm -rf "${LIB}/curses"
rm -rf "${LIB}/sqlite3"
rm -rf "${LIB}/email"
...
rm -rf "${LIB}/tomllib"
rm -rf "${LIB}/zipfile"
rm -rf "${LIB}/tarfile.py"
rm -rf "${LIB}/pdb.py"
rm -rf "${LIB}/profile.py"
rm -rf "${LIB}/cProfile.py"
rm -rf "${LIB}/pstats.py"
rm -rf "${LIB}/timeit.py"
rm -rf "${LIB}/trace.py"
rm -rf "${LIB}/dataclasses.py"
rm -rf "${LIB}/decimal.py"
rm -rf "${LIB}/fractions.py"
rm -rf "${LIB}/statistics.py"
rm -rf "${LIB}/csv.py"
rm -rf "${LIB}/mailbox.py" "${LIB}/mailcap.py"
rm -rf "${LIB}/imaplib.py" "${LIB}/smtplib.py" "${LIB}/ftplib.py" "${LIB}/poplib.py"
rm -rf "${LIB}/nntplib.py" "${LIB}/telnetlib.py"
rm -rf "${LIB}/socketserver.py"
rm -rf "${LIB}/wsgiref"
rm -rf "${LIB}/venv"
rm -rf "${LIB}/pip" "${LIB}/setuptools"
rm -rf "${LIB}/pkg_resources"
rm -rf "${LIB}/antigravity.py"
rm -rf "${LIB}/calendar.py"
rm -rf "${LIB}/difflib.py"
rm -rf "${LIB}/gettext.py"
rm -rf "${LIB}/pprint.py"
rm -rf "${LIB}/textwrap.py"
rm -rf "${LIB}/pickletools.py"
rm -rf "${LIB}/compileall.py"
rm -rf "${LIB}/py_compile.py"
rm -rf "${LIB}/_android_support.py"
rm -rf "${LIB}/_ios_support.py"
rm -rf "${LIB}/_apple_support.py"
